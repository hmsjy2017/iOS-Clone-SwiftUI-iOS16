        ...
        .toolbar {
            ...
            ToolbarItem(placement: .topBarTrailing) {
                Button(action: { isLiked.toggle() }) {
                    Image(systemName: isLiked ? "heart.fill" : "heart")
                        .foregroundColor(isLiked ? .white : .white) // iOS Photos uses white icon unless active, then solid
                }
            }
            ...
            ToolbarItem(placement: .bottomBar) {
                HStack {
                    ...
                    Button(action: { isLiked.toggle() }) {
                        Image(systemName: isLiked ? "heart.fill" : "heart")
                            .foregroundColor(isLiked ? .red : .blue) // iOS uses Blue/Red in bottom bar context sometimes
                    }
                    Spacer()
