                ...
                Section {
                    ...
                    NavigationLink(destination: Text("Cellular Settings")) {
                        HStack {
                            ...
                            Spacer()
                            if airplaneMode { Text("Off").foregroundColor(.secondary) }
                        }
                    }
                    ...
                    NavigationLink(destination: Text("Hotspot Settings")) {
                        HStack {
                            ...
                            Spacer()
                            Text(airplaneMode ? "Off" : "Off").foregroundColor(.secondary)
                        }
                    }
                }
...
struct AboutView: View {
    var body: some View {
        List {
            ...
            Section {
                HStack { Text("Coverage"); Spacer(); Text("Expired").foregroundColor(.secondary); Image(systemName: "chevron.right").font(.caption).foregroundColor(.tertiary) }
            }
            Section {
        ...
        List {
            ...
            Section(header: Text("Recommendations")) {
                HStack {
                    ...
                    Spacer()
                    Text("3.2 GB").foregroundColor(.secondary)
                    Image(systemName: "chevron.right").font(.caption).foregroundColor(.tertiary)
                }
            }
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading) {
                Text(name)
                Text("Last used: Yesterday").font(.caption).foregroundColor(.secondary)
            }
            Spacer()
    ...
    var body: some View {
        List {
                ...
                HStack(spacing: 20) {
                    ...
                    VStack {
                        RoundedRectangle(cornerRadius: 10)
                            ...
                            .frame(height: 60)
                            .overlay(Image(systemName: "sun.max.fill").font(.largeTitle).foregroundColor(.black))
                    ...
                    VStack {
                        RoundedRectangle(cornerRadius: 10)
                            .fill(Color.black)
                            .frame(height: 60)
                            .overlay(Image(systemName: "moon.fill").font(.largeTitle).foregroundColor(.white))
            ...
            Section(header: Text("Brightness")) {
                HStack {
                    Image(systemName: "sun.min.fill").foregroundColor(.secondary)
                    Slider(value: $brightness)
                    Image(systemName: "sun.max.fill").foregroundColor(.secondary)
                }
            ...
            Section {
                NavigationLink("Auto-Lock") {
                    List {
                        ...
                        HStack { Text("1 Minute"); Spacer(); Image(systemName: "checkmark").foregroundColor(.blue) }
        ...
        List {
            ...
            Section(header: Text("Last 24 Hours")) {
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    HStack {
                        Text("12 AM").font(.caption2).foregroundColor(.secondary)
                        Spacer()
                        Text("6 AM").font(.caption2).foregroundColor(.secondary)
                        Spacer()
                        Text("12 PM").font(.caption2).foregroundColor(.secondary)
                        Spacer()
                        Text("6 PM").font(.caption2).foregroundColor(.secondary)
                    }
                }
                .padding(.vertical)
            }
        ...
        List {
            ...
            Section {
                NavigationLink("Ringtone") {
                    List {
                        HStack { Text("Reflection"); Spacer(); Image(systemName: "checkmark").foregroundColor(.blue) }
                        Text("Apex")
                        Text("Beacon")
                    }
                ...
                NavigationLink("Text Tone") {
                    List {
                        HStack { Text("Note"); Spacer(); Image(systemName: "checkmark").foregroundColor(.blue) }
                        Text("Popcorn")
            ...
            Section {
                NavigationLink { } label: {
                    HStack {
                        ...
                        Spacer()
                        Text("200 GB").foregroundColor(.secondary)
                    }
                }
