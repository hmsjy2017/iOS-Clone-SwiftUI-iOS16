    ...
    var body: some View {
        HStack(spacing: 12) {
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                ...
                .overlay(Image(systemName: app.iconSymbol).foregroundColor(.white).font(.title2))
            ...
            VStack(spacing: 20) {
                ...
                HStack(spacing: 16) {
                    RoundedRectangle(cornerRadius: 22, style: .continuous)
                        ...
                        .overlay(Image(systemName: app.iconSymbol).font(.system(size: 50)).foregroundColor(.white))
...
struct AccountIcon: View {
    var body: some View {
        Circle()
            ...
            .overlay(Text("JA").font(.caption).fontWeight(.bold).foregroundColor(.white))
    }
}
    ...
    var body: some View {
        NavigationStack {
            List {
                Section {
                    HStack(spacing: 12) {
                        Circle().fill(.blue).frame(width: 50, height: 50).overlay(Text("JA").foregroundColor(.white))
                        VStack(alignment: .leading) {
                            Text("John Appleseed").font(.headline)
                            Text("john.appleseed@icloud.com").font(.caption).foregroundColor(.secondary)
                        }
                    }
                }
                ...
                Section {
                    Button("Sign Out") { dismiss() }.foregroundColor(.blue)
                }
            }
